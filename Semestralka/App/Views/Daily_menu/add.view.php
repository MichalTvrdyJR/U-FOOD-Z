    ...
    <div class="card card-colors card-signin">
        <form class="card-body p-5 text-center form-signin" method="post">
            ...
            <div>
                ...
                <input onkeyup="enable_submit_button(this.value, 2)" value="<?=$value ?>" type="text" name="price" class="form-control" id="price" aria-describedby="Help" placeholder="Enter Price" required>
